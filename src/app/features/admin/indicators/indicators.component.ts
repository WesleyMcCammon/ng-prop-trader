...
const GROUPS_DEF: Omit<IndicatorGroup, 'show'>[] = [
  ...
  },
  {
    ...
    name: 'Volume Profile',
    levels: [
      { id: 'vp.vah', label: 'Value Area High',  name: 'Value Area High' },
      { id: 'vp.poc', label: 'Point of Control', name: 'Point of Control' },
      { id: 'vp.val', label: 'Value Area Low',   name: 'Value Area Low' },
    ],
  },
  {
    id: 'openingRange',
